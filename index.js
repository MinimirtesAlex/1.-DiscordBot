...
const PREFIX = '.';
const TOKEN = 'ODE4ODI4MDY5NTczMjMwNjEz.YEdvEA.6_u3HUbKpBjWbRLURSye3p2Wdbg';
...
bot.on('message', message =>{
    ...
    switch (lowercaseargs[0]){
        ...
        case 'clear':
            ...
            if(!args[1]) return message.channel.send('Fehler, bitte gib eine Zahl zwischen 1 und 99 als zweiten Parameter an!')
